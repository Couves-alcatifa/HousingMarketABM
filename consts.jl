...
### CRASH SCENARIO
# STARTING_INTEREST_RATE = 0.0504
STARTING_INTEREST_RATE = 0.015
LTV = 0.85
DSTI = 0.35
IRS = 0.2
VAT = 0.15
...
EXPECTED_RENOVATION_RENTABILITY = 0.2 # 20% of the investment
ADDED_VALUE_TAXABLE_PERCENTAGE = 0.5
...
CONSUMER_SURPLUS_MIN_FOR_RENT = 0.98
...
SUM_WEALTH_RATIO = sum([RELATIVE_WEALTH_RATIO[location] for location in instances(HouseLocation)])

NORMALIZED_WEALTH_RATIO = Dict(
...
MEAN_NORMALIZED_WEALTH_RATIO = mean([NORMALIZED_WEALTH_RATIO[location] for location in instances(HouseLocation)])

WEALTH_RATIO_MULTIPLIER_MAP = Dict(
    Amadora => NORMALIZED_WEALTH_RATIO[Amadora] / MEAN_NORMALIZED_WEALTH_RATIO,
    Cascais => NORMALIZED_WEALTH_RATIO[Cascais] / MEAN_NORMALIZED_WEALTH_RATIO,
    Lisboa => NORMALIZED_WEALTH_RATIO[Lisboa] / MEAN_NORMALIZED_WEALTH_RATIO,
    Loures => NORMALIZED_WEALTH_RATIO[Loures] / MEAN_NORMALIZED_WEALTH_RATIO,
    Mafra => NORMALIZED_WEALTH_RATIO[Mafra] / MEAN_NORMALIZED_WEALTH_RATIO,
    Odivelas => NORMALIZED_WEALTH_RATIO[Odivelas] / MEAN_NORMALIZED_WEALTH_RATIO,
    Oeiras => NORMALIZED_WEALTH_RATIO[Oeiras] / MEAN_NORMALIZED_WEALTH_RATIO,
    Sintra => NORMALIZED_WEALTH_RATIO[Sintra] / MEAN_NORMALIZED_WEALTH_RATIO,
    VilaFrancaDeXira => NORMALIZED_WEALTH_RATIO[VilaFrancaDeXira] / MEAN_NORMALIZED_WEALTH_RATIO,
    Alcochete => NORMALIZED_WEALTH_RATIO[Alcochete] / MEAN_NORMALIZED_WEALTH_RATIO,
    Almada => NORMALIZED_WEALTH_RATIO[Almada] / MEAN_NORMALIZED_WEALTH_RATIO,
    Barreiro => NORMALIZED_WEALTH_RATIO[Barreiro] / MEAN_NORMALIZED_WEALTH_RATIO,
    Moita => NORMALIZED_WEALTH_RATIO[Moita] / MEAN_NORMALIZED_WEALTH_RATIO,
    Montijo => NORMALIZED_WEALTH_RATIO[Montijo] / MEAN_NORMALIZED_WEALTH_RATIO,
    Palmela => NORMALIZED_WEALTH_RATIO[Palmela] / MEAN_NORMALIZED_WEALTH_RATIO,
    Seixal => NORMALIZED_WEALTH_RATIO[Seixal] / MEAN_NORMALIZED_WEALTH_RATIO,
    Sesimbra => NORMALIZED_WEALTH_RATIO[Sesimbra] / MEAN_NORMALIZED_WEALTH_RATIO,
    Setubal => NORMALIZED_WEALTH_RATIO[Setubal] / MEAN_NORMALIZED_WEALTH_RATIO
)
