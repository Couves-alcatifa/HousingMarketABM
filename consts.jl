...
const INITIAL_MARKET_PRICE_CUT = 0.90
...
const MAX_BUCKET_SIZE = Int64(round(300 * MODEL_SCALE))
const MINIMUM_NUMBER_OF_TRANSACTIONS_IN_BUCKETS = Int64(round(25 * MODEL_SCALE))
