...
const RECENTLY_BUILD_MINIMUM_PERCENTILE = 0.90
...
const NUMBER_OF_HOUSEHOLDS_WITH_AGES_LMA = Dict(
    ...
    30 => NUMBER_OF_PEOPLE_WITH_AGES_LMA[30] + sum([NUMBER_OF_PEOPLE_WITH_AGES_LMA[age] for age in [0,10,20]]) / 3,
    40 => NUMBER_OF_PEOPLE_WITH_AGES_LMA[40] + sum([NUMBER_OF_PEOPLE_WITH_AGES_LMA[age] for age in [0,10,20]]) / 3 +  + NUMBER_OF_PEOPLE_WITH_AGES_LMA[20] / 4,
    50 => NUMBER_OF_PEOPLE_WITH_AGES_LMA[50] + sum([NUMBER_OF_PEOPLE_WITH_AGES_LMA[age] for age in [0,10,20]]) / 3 +  + NUMBER_OF_PEOPLE_WITH_AGES_LMA[20] / 4,
